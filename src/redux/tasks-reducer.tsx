    ...
    tasksData: [
        {
            ...
            description: [
                <>
                    <Accordion>
                        <Accordion.Item eventKey="0">
                            ...
                            <Accordion.Body>
                                ...
                                <p>Насчёт дизайна можете много не думать – ссылок, кнопок и заголовков будет достаточно. Тем не менее
                    ...
                    <p></p>
                    <h5>Для поиска по репозиториям GutHub нужно создать свой токен:</h5>
            ...
            Fine-grained personal access tokens => `}
                    ...
                    <p>React + redux + TS + GraphQl + PlayWright</p>
                    <a href="https://uchenick55.github.io/github-repository-search/">Ссылка на работу</a>
                </>
            ],
