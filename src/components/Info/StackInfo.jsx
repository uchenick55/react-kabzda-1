...
let StackInfo = () => {
    const usedStack = <div>
        ...
        <p>UI (React): create-react-app, function component, props (spread), import /export (named/default),
            ...
            (NavLink/Navigate/Routes/Route), Lifting State Up, top-down (unidirectional) flow, props.children, fragment </p>
        ...
        <p>JS: try/catch/finally, setTimeout/setInterval, Object.keys/values, Math.ceil, new Date(), JSON.stringify, deep/shallow copy, closure, map, filter, some.</p>
